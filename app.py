...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function getDefaultData() {
        return {
            "3": { "direction": "CORSA DEVIATA", "stops": [{ "name": "VALLETTE CAP.", "subtitle": "" }, { "name": "PRIMULE", "subtitle": "" }, { "name": "PERVINCHE", "subtitle": "" }, { "name": "SANSOVINO", "subtitle": "" }, { "name": "CINCINNATO", "subtitle": "MERCATO RIONALE" }] }, { "name": "LOMBARDIA", "subtitle": "PISCINA LOMBARDIA" }] }, { "name": "BORSI", "subtitle": "" }]   { "name": "LARGO TOSCANA", "subtitle": "" }] }, { "name": "LARGO BORGARO", "subtitle": "" }] }, { "name": "PIERO DELLA FRANCESCA", "subtitle": "MUSEO A COME AMBIENTE" }] },  { "name": "OSPEDALE AMEDEO DI SAVOIA", "subtitle": "DIPARTIMENTO DI INFORMATICA" }] }, { "name": "TASSONI", "subtitle": "" }] }, { "name": "AVELLINO", "subtitle": "" }] }, { "name": "LIVORNO", "subtitle": "" }] }, { "name": "INDUSTRIA", "subtitle": "" }] }, { "name": "RONDÒ FORCA OVEST", "subtitle": "MARIA AUSILIATRICE" }] }, { "name": "OSPEDALE COTTOLENGO", "subtitle": "ANAGRAFE CENTRALE" }] }, { "name": "PORTA PALAZZO EST", "subtitle": "PIAZZA DELLA REPUBBLICA" }] }, { "name": "XI FEBBRAIO", "subtitle": "AUTOSTAZIONE DORA" }] }, { "name": "GIARDINI REALI", "subtitle": "" }] }, { "name": "ROSSINI", "subtitle": "" }] }, { "name": "CAMPUS EINAUDI", "subtitle": "" }] }, { "name": "LARGO BERARDI", "subtitle": "" }] }, { "name": "RICASOLI", "subtitle": "" }] }, { "name": "BELGIO", "subtitle": "" }] }, { "name": "OSPEDALE GRADENIGO", "subtitle": "" }] }, { "name": "LARGO BERARDI", "subtitle": "" }] },
